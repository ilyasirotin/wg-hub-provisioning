...
/routing id
add id=10.99.0.12 name=wg-bgp-id
/routing bgp instance
add as=65012 name=wg-bgp-inst router-id=wg-bgp-id
...
add allowed-address=10.99.0.0/24,10.1.0.0/16 client-allowed-address=::/0 \
...
add address=10.2.20.0/24 comment="Management from Trusted WiFi" list=\
    Admin_Access
add address=10.2.0.0/16 comment="BGP Export" list=BGP_Export
/ip firewall filter
...
/ip route
add blackhole comment="BGP advertisement anchor" dst-address=10.2.0.0/16
/ip service
