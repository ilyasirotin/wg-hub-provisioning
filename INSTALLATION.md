...
# site: site_a - House A - primary (exit node)
# AllowedIPs = 0.0.0.0/0 позволяет хабу шифровать интернет-трафик
# home-профильных клиентов в сторону этого роутера; маршруты других пиров
# выигрывают по длине префикса.
[Peer]
...
# pixel_10_pro_home (profile: home) -> интернет через домашний роутер
